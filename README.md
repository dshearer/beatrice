...
**One-time setup:** From the command palette, run "Beatrice: Install Agent Prompt". This adds the custom agent prompt at `.github/agents/beatrice.agent.md`. Feel free to commit this to git.
...
At the bottom of the Copilot Chat view, there's a popup menu labelled "Agent"; click on that and you'll see "Beatrice":
