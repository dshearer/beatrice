...
- **THEN** extension shows brief status bar message prefixed with "Beatrice:" confirming action

#### Scenario: Error notification
- **WHEN** tool invocation fails
- **THEN** extension shows error message to user prefixed with "Beatrice:"
